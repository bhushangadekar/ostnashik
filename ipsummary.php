...
<div class="container bg">
    ...
    <div class="row clearfix">
    	<div class="col-md-12 column">
        	<div class="admin" >
                <h2 class="text-center text-primary">Visitors Summary For OSTNashik ! </h2><br><br><br>
                <?php	
                include 'config.php';			
                $sql="SELECT id,ip_address,timeofvisit,dateofvisit FROM visitors ORDER BY id DESC ";
                ...
                {						
                    echo "<tr class='success'>
						  ...
						  <td class='date'>" . $row["ip_address"]. "</td>
						  <td class='date'>" . $row["dateofvisit"]. "</td>
						  <td class='date'>" . $row["timeofvisit"]. "</td>
						  </tr>";
              	}	
