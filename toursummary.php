...
<div class="container bg">
    ...
    <div class="row clearfix">
    	<div class="col-md-12 column">
        	<div class="admin" >
                <h2 class="text-center text-primary">2-Hour Support Tour Subscriber Summary For OSTNashik ! </h2><br><br><br>
                <?php	
                include 'config.php';			
                $sql="SELECT * FROM freetours ORDER BY id ASC ";
                ...
                {						
                    echo "<tr class='success'>
						  ...
						  <td class='date'>" . $row["name"]. "</td>
						  <td class='date'>" . $row["password"]. "</td>
						  <td class='date'>" . $row["company"]. "</td>
						  <td class='date'>" . $row["address"]. "</td>
						  <td class='date'>" . $row["email"]. "</td>
						  <td class='date'>" . $row["mobile"]. "</td>
