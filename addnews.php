...
<div class="container bg">
    ...
    <div class="row clearfix">
    	<div class="col-md-8 column">
        	<div align="center">            
            <h2 class="text-center text-danger">Enter The Latest News Here </h2>
            <div class="formbox">
           <form name="form" method="post" action="insertnews.php">
           	  <table class="table borderless">
              	<tr >
                	<td style="border-top: none;"><div class="form-group" ><label>Title  </label></div></td>
                    <td style="border-top: none;"><div class="form-group" ><input name="title" type="text" id="title" required></div></td>
                </tr>
                <tr>
                	<td style="border-top: none;"><div class="form-group" ><label>Description</label></div></td>
                    <td style="border-top: none;"><div class="form-group" ><textarea name="description" id="description" cols="30" rows="4" required></textarea></div></td>
                </tr>
                <tr>
                	<td style="border-top: none;"><div class="form-group" ><label>Date of Posting</label></div></td>
                    <td style="border-top: none;"><div class="form-group" ><input id="datepicker" name="postdate" required/></div></td>
                </tr>                
                <tr>
                	<td style="border-top: none;"><div class="form-group" ><label>Due Date for News</label></div></td>
                    <td style="border-top: none;"><div class="form-group" ><input id="datepicker1" name="duedate"  required /></div></td>
                </tr>
              	</table>                                   
              <br>
